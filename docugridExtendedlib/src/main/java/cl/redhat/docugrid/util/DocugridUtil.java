...
public class DocugridUtil {
	...
	/**
	 * Metodo estatico que lee configuraciones de docugrid desde la variable de
	...
	public static String docugridProperty(String name) {
		...
		try {
			InputStream inputStream = new FileInputStream(System.getenv("JBOSS_HOME") + "/" + PROPERTIES_FILE);
	...
	public static String listarDocumentos(DocugridResponse docugridResponse, String urlRest) {
		String response = "";
		try {
			int read = 0;
			byte[] buffer = new byte[1024 * 8];
	...
	public static String eliminarcache(DocugridResponse docugridResponse, String urlRest) {
		String response = "";
		try {
			int read = 0;
			byte[] buffer = new byte[1024 * 8];
	...
	public static String leerVersiones(DocugridResponse docugridResponse, String urlRest) {
		String response = "";
		try {
			int read = 0;
			byte[] buffer = new byte[1024 * 8];
